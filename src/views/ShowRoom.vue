              ...
              <el-col :span="6" v-for="room of roomArr" class="room-box-wrapper">
                <div class="room-box">
                  ...
                  <div class="text-center" style="height:60px;">
                    <el-button class="enterBtn" type="primary" round plain>Enter</el-button>
                  </div>
...
export default Vue.extend({
  ...
  mounted(){
    ...
    } else {// 已经设置了昵称，应该是刷新了页面
      this.nickname = nickname;
      this.newNickname = nickname;
    }
    
    Array.from({length:10}).forEach((item,index)=>this.roomArr.push({id:index,name:index,peopleNum:index}))
          ...
          .room-list {
            ...
            .room-box-wrapper {
              ...
              .room-box {
                ...
                .show-room-id,.show-room-peopleNum {
                  font-size:10px;
